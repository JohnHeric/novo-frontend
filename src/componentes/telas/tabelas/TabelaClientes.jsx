...
export default function TabelaClientes(props) {
    const { estado, mensagem, listaDeClientes } = useSelector(estado => estado.cliente);
    ...
    if (estado === ESTADO.PENDENTE) {
        ...
        return (
            <Container>
                ...
                <p>Quantidade de clientes cadastrados: {listaDeClientes ? listaDeClientes.length : 0}</p>
            </Container>
        );
    }
}