...
export default function TabelaCategorias(props) {
    const { estado, mensagem, listaDeCategorias } = useSelector(estado => estado.categoria);
    ...
    if (estado === ESTADO.PENDENTE) {
        ...
        return (
            <Container>
                ...
                <p>Quantidade de categorias cadastradas: {listaDeCategorias ? listaDeCategorias.length : 0}</p>
            </Container>
        );
    }
}